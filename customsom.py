...
class MiniSom(object):
    ...
    def train(self, data, num_iteration,
        ...
        self.iterations = list(_build_iteration_indexes(len(data), num_iteration,
    ...
    def train_step(self):
        decay_rate = self.get_decay_rate(self.t, len(self.data))
        self.update(self.data[self.iterations[self.t]], self.winner(self.data[self.iterations[self.t]]),
                    decay_rate, self.num_iteration)
        self.t = (self.t + 1) % len(self.iterations)
